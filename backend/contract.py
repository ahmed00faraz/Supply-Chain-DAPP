...
w3 = Web3(Web3.HTTPProvider(
    "https://eth-sepolia.g.alchemy.com/v2/EmQroN4Zy5EYBbcD5m1YodQJNZdAz4OV"))
...
# private key account
key = "c51713e305ea54587e21af9f14b9a8e6b8c25f5f1923f25d3f7fd92176c532b4"

# account address
account = w3.to_checksum_address('0x799B4Bc86c5Def4ff8475cc6545728be688D2D4a')

# contract address
address = w3.to_checksum_address('0x535a89eb209cb9a98fe222f3a90293d9B6130A28')
...
def AddProduct(name, price, description, reqtemp, manufacturing,timestamp):
